    ...
    <main className="shell">
      ...
      <section className="grid secondary-grid">
        <article className="panel preview-panel">
          ...
          {result?.task_id === "region-and-tool-segmentation" &&
          result?.segmentation_overlay_png_base64 ? (
            <img
              className="frame-preview"
              src={`data:image/png;base64,${result.segmentation_overlay_png_base64}`}
              alt="Segmentation overlay preview"
            />
          ) : previewUrl ? (
            <img
              className="frame-preview"
              src={previewUrl}
              alt="Endoscopic frame preview"
            />
          ) : (
