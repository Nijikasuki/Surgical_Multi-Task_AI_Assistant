...
start "Backend :8000" cmd /k "call conda activate surgical_ai && python main.py"

echo Starting Multilix (Flask) on http://127.0.0.1:5001 ...
start "Multilix :5001" cmd /k "call conda activate surgical_ai && cd modules\multilix && python app_with_model_and_loading.py"
